        ...
        <div class="timeProgress">
          ...
          <div class="tips">
            ...
            <div class="controlButtons">
              ...
              <div class="playbutton offset" @click="showMessage('开发中')">
                <svg t="1758183975427" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4540" width="24" height="24"><path d="M443.392 581.12L215.552 203.264H368.64l144.384 244.224 143.872-244.224h151.552L579.072 583.68v237.056H443.392v-239.616zM508.416 90.112l71.68 71.68 31.744-31.744L508.416 26.112 404.992 130.048l32.256 31.744 71.168-71.68z m7.168 843.776l-71.68-71.68-31.744 31.744 103.424 103.424 103.424-103.424-32.256-31.744-71.168 71.68z" fill="currentColor" p-id="4541"></path></svg>
              </div>
            </div>
